...
Do not include passwords, API keys, access tokens, private customer information, private repository contents, proprietary implementation material, or other credentials unless a secure exchange method has been established.

## Scope of This Repository

`RATTER-info` is a public information repository. It does not contain the private RATTER source code or proprietary implementation.
